      ...
      markdownItSetup(md) {
        md.use(MarkdownItMagicLink, {
          linksMap: {
            ...
            'TypeScript': { link: 'https://typescriptlang.org', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Typescript_logo_2020.svg/512px-Typescript_logo_2020.svg.png' },
